...
client.on("messageCreate", async (message) => {
    ...
    const embed = new EmbedBuilder()
        .setDescription(`> <:pookie_roke_happy:1380160673593425981> Hey ${message.author},\n> <:Harmonia_info:1383066959419146272> Prefix For This Server \`${config.prefix}\`\n\n- __Type \`${config.prefix}help\` for more information.__`)
        .setThumbnail(client.user.displayAvatarURL())
        .setFooter({ text: "Love From Harmonia's Team <3", iconURL: client.user.displayAvatarURL() })
